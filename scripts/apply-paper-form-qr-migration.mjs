/**
 * Aplikuje migraci 055_paper_form_qr_form_number.sql
 */
...
const sql = readFileSync(resolve(process.cwd(), 'supabase/migrations/055_paper_form_qr_form_number.sql'), 'utf8')
...
async function applyViaPg() {
  ...
  await client.end()
  console.log('OK: Migrace 055 aplikována.')
}
