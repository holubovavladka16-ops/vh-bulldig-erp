/**
 * Aplikuje migraci 058_paper_form_replacement.sql
 */
...
const sql = readFileSync(resolve(process.cwd(), 'supabase/migrations/058_paper_form_replacement.sql'), 'utf8')
...
async function applyViaPg() {
  ...
  await client.end()
  console.log('OK: Migrace 058 aplikována.')
}
