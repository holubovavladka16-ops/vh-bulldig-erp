/**
 * Aplikuje migraci 057_security_audit_hardening.sql
 */
...
const sql = readFileSync(resolve(process.cwd(), 'supabase/migrations/057_security_audit_hardening.sql'), 'utf8')
...
async function applyViaPg() {
  ...
  await client.end()
  console.log('OK: Migrace 057 aplikována.')
}
