  ...
  return (
    <>
      ...
      <aside
        className={
          isSheet
            ? 'fixed inset-x-0 bottom-0 z-50 max-h-[92vh] overflow-hidden rounded-t-2xl border border-[var(--accent-primary)]/40 bg-[var(--bg-glass)] shadow-[0_-8px_40px_rgba(0,0,0,0.45)] lg:hidden'
            : 'hidden h-full w-full shrink-0 flex-col overflow-hidden rounded-2xl border border-[var(--accent-primary)]/40 bg-[var(--bg-glass)] shadow-[0_0_24px_var(--accent-glow)] lg:flex lg:w-[min(440px,40vw)]'
        }
      >
