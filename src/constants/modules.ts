...
export const FUTURE_MODULES: NavItem[] = [
  ...
  { id: 'denni-kalendar', label: 'Denní provozní kalendář', path: '/daily-calendar', icon: 'Calendar', module: 'denni-kalendar' },
  { id: 'fakturacni-vykaz', label: 'Fakturační výkaz prací', path: '/fakturacni-vykaz', icon: 'Calculator', module: 'fakturacni-vykaz' },
