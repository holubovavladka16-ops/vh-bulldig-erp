...
export const WORK_TYPE_DESCRIPTIONS: Record<WorkType, string> = {
  hodinova: 'Evidence docházky bez výkonů. Výdělek 0 Kč, pokud není přidán žádný placený výkon.',
  ukolova: 'Výdělek se počítá výhradně z výkonů podle osobního ceníku. Hodiny slouží jen jako evidence docházky.',
  kombinovana: 'Výdělek se počítá výhradně z výkonů podle osobního ceníku (může zahrnovat i výkon „Hodinová práce").',
}
...
export const DEFAULT_PRICE_ITEMS: { name: string; unit_type: PriceUnitType; sort_order: number }[] = [
  { name: 'Hodinová práce', unit_type: 'hodina', sort_order: 1 },
