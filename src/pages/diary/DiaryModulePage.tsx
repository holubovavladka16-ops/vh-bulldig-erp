  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        description="Rychlý nástroj: vyberte zakázku a datum, systém načte dělníky z docházky a fotky z Fotodokumentace. Exportujte jednotlivý den nebo celý deník do PDF A4."
        action={
          isAdmin ? (
