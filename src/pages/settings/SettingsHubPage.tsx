...
function getSettingsDescription(id: string): string {
  const descriptions: Record<string, string> = {
    ...
    'nastaveni-vzhled': 'Přepínání Design 1 (původní) a Design 2 (prémiový) pro celou firmu',
    'nastaveni-vodoznak-pdf': 'Vlastní vodoznak pro všechny PDF – nahrání, průhlednost, velikost, náhled',
  }
