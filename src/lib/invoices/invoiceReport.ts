...
const INVOICE_PRINT_CSS = `
  ...
  .doc-header { border-bottom-color: #1d5c96 !important; margin-bottom: 14px !important; }
  .doc-title-block { margin-bottom: 14px !important; }
  .doc-company-name, .doc-title, .doc-section h2, .doc-party h3 { color: #123a63 !important; }
  .doc-table th { background: #eaf3fb !important; color: #123a63 !important; border-color: #a9c9e8 !important; }
  .doc-table td { border-color: #d7e6f3 !important; }
  .doc-party { border-color: #a9c9e8 !important; background: #f6fafd !important; }
  ...
  .invoice-accent { color: #1d5c96; font-weight: 700; }
  ...
  .invoice-totals td { padding: 5px 0; border-bottom: 1px solid #d7e6f3; vertical-align: baseline; }
  ...
  .invoice-totals tr.grand-row td { border-bottom: none; border-top: 2px solid #1d5c96; padding-top: 7px; }
  .invoice-totals .grand { font-size: 11.5pt; font-weight: 700; color: #123a63; }
  .invoice-qr-wrap { text-align: center; margin: 10px 0 6px; page-break-inside: avoid; }
  .invoice-qr-wrap img { width: 36mm; height: 36mm; border: 1px solid #a9c9e8; padding: 4px; background: #fff; }
  ...
  return `
    <section class="doc-section">
      ...
      <div class="invoice-qr-wrap">
        ...
        <p>Variabilní symbol: <span class="invoice-accent">${escHtml(invoice.variable_symbol)}</span></p>
  ...
  return `
    ...
    <section class="doc-section">
      <div class="doc-meta-grid">
        ...
        <div><span class="label">Variabilní symbol:</span> <span class="invoice-accent">${escHtml(invoice.variable_symbol)}</span></div>
